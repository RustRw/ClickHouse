...
MergeTreeWhereOptimizer::MergeTreeWhereOptimizer(
    ...
    Logger * log)
        ...
        table_columns{ext::map<std::unordered_set>(data.table_declaration.getColumnsList(),
            [] (const NameAndTypePair & col) { return col.name; })},
        block_with_constants{PKCondition::getBlockWithConstants(query_info.query, context, data.table_declaration.getColumnsList())},
